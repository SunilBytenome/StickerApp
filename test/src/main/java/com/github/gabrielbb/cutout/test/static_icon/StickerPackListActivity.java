...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    private ImageView ivAddNewPack,ivBack;
    ...
    private void initView() {
     ...
     /*   ivBack.setOnClickListener(new View.OnClickListener() {
        ...
        ivAddNewPack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(StickerPackListActivity.this, com.github.gabrielbb.cutout.test.WhatsAppBasedCode.StickerPackListActivity.class));
            }
        });

        showStickerPackList(stickerPackList);
     /*   if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("STICKER CREATER");
        }*/
       ...
       new MaterialIntroView.Builder(this)
                ...
                .setInfoText("To create your own sticker packs, click here.")

                .setShape(ShapeType.CIRCLE)
                .setTarget(ivAddNewPack)
    ...
    private void recalculateColumnCount() {
        ...
        if (viewHolder != null) {
            ...
            allStickerPacksListAdapter.setImageRowSpec(maxNumberOfImagesInARow, 10);
        }
    }
