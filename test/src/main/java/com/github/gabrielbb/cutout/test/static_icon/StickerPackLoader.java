...
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.AVOID_CACHE;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.IMAGE_DATA_VERSION;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.PUBLISHER_EMAIL;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.PUBLISHER_WEBSITE;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static com.github.gabrielbb.cutout.test.static_icon.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
    ...
    private static List<Sticker> getStickersForPack(Context context, StickerPack stickerPack) {
        ...
        for (Sticker sticker : stickers) {
            ...
            try {
                ...
                throw new IllegalStateException("Asset file doesn't exist. pack: " + stickerPack.name + ", sticker: " + sticker.imageFileName+" stickers.size()"+bytes.length, e);
            }
        }
        return stickers;
    }
