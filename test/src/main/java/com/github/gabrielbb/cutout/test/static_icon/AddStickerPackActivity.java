    ...
    public static final class StickerPackNotAddedMessageFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(getActivity())
                    .setMessage("add_pack_fail_prompt_update_whatsapp")
                    .setCancelable(true)
                    .setPositiveButton(android.R.string.ok, (dialog, which) -> dismiss())
                    .setNeutralButton("add_pack_fail_prompt_update_play_link", (dialog, which) -> launchWhatsAppPlayStorePage());
        ...
        private void launchPlayStoreWithUri(String uriString) {
            ...
            try {
                ...
                Toast.makeText(getActivity(),"cannot_find_play_store", Toast.LENGTH_LONG).show();
            }
        }
    }
}
